...
public class WorkoutServiceApplication {
    ...
    public WorkoutServiceApplication(ReactiveMongoOperations mongoTemplate) {
    ...
    public void initIndicesAfterStartup() {
        ...
        var indexOps = mongoTemplate.indexOps(WorkoutEntity.class);
        resolver.resolveIndexFor(WorkoutEntity.class).forEach(e -> indexOps.createIndex(e).block());
    }

    public static void main(String[] args) {
        Hooks.enableAutomaticContextPropagation();
        var ctx = SpringApplication.run(WorkoutServiceApplication.class, args);
