...
public class AuthorizationServerConfig {
    ...
    public RegisteredClientRepository registeredClientRepository() {
        var writerClient = RegisteredClient.withId(UUID.randomUUID().toString())
                ...
                .redirectUri("https://localhost:8443/workouts/openapi/swagger-ui/oauth2-redirect.html")
                .redirectUri("https://localhost:8443/exercises/openapi/swagger-ui/oauth2-redirect.html")
                .redirectUri("https://localhost:8443/user-composite/openapi/swagger-ui/oauth2-redirect.html")
