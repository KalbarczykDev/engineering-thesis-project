# Engineering Thesis
This repository contains the software and supporting documentation developed for my Engineering thesis, which focuses on building a microservice-based application for monitoring strength training progress. The project is implemented using Spring Boot, with MySQL and MongoDB as databases, and utilizes Docker and Docker Compose for deployment.
...
## Contributing
This project exists only in my private repository for the purpose of my Engineering thesis. Therefore, contributions from external developers are not accepted at this time.
